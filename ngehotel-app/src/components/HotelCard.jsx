...
// propsnya langsung di dektructuring di parameter, sama saja seperti yang biasa kamu lakukan
const HotelCard = ({ room, index }) => {
  // const { rooms, index } = props;
    ...
    >
      ...
      <div className="p-4 pt-5">
        ...
        <div className="flex items-center gap-1 text-sm">
              <img src={assets.locationIcon} alt="start-icon" />
